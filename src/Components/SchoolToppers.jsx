...
export default function SchoolToppers() {
  const toppersData = {
    ...
    std11: {
      title: 'SCHOOL TOPPERS STD - XI',
      students: [
        {
          name: 'Arjun Patel',
          image: 'https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=600&q=80',
          group: 'Computer Science - Centum in Maths',
          score: 589,
          outOf: 600,
          rank: 1
        },
    ...
    std10: {
      title: 'SCHOOL TOPPERS STD - X',
      students: [
        {
          name: 'Sneha Menon',
          image: 'https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=600&q=80',
          group: 'Centum in Maths',
          score: 497,
          outOf: 500,
          rank: 1
        },
  ...
  const ToppersSection = ({ data }) => (
    <div className="mb-24">
      ...
      <div className="flex flex-wrap justify-center gap-12 lg:gap-16 max-w-6xl mx-auto">
        ...
        <StudentCard student={data.students[0]} index={0} />
        
        {/* Rank 2 and 3 */}
        <StudentCard student={data.students[1]} index={1} />
        <StudentCard student={data.students[2]} index={2} />
      </div>
    </div>
  );
